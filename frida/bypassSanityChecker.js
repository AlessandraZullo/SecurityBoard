/**
  Bypass Root della classe RootChecker
 **/
Java.perform(function () {
    var RootChecker = Java.use('com.x.x.controller.security.RootChecker');
    RootChecker.checkIfRooted.overload().implementation = function () {
        console.log('[kebby] onRootDetected() bypassed');
        return false;
    };
});

/**
  Bypass Emulator check
 **/
Java.perform(function () {
    var SanityChecker = Java.use('com.x.x.controller.security.SanityChecker');
    SanityChecker.onEmulatorDetected.overload().implementation = function () {
        console.log('[kebby] onEmulatorDetected() bypassed');
        return ;
    };
});

/**
  Bypass Root della classe Sanity check che ricontrolla il root
 **/
Java.perform(function () {
    var SanityChecker = Java.use('com.x.x.controller.security.SanityChecker');
    SanityChecker.onRootDetected.overload().implementation = function () {
        console.log('[kebby] onRootDetected() bypassed');
        return ;
    };
});
...
/**
  Bypass check hooking
 **/
Java.perform(function () {
    var SanityChecker = Java.use('com.x.x.controller.security.SanityChecker');
    SanityChecker.onHookDetected.overload().implementation = function () {
        console.log('[kebby] onHookDetected() bypassed');
        return ;
    };
});

/** pinning copiato da @akabe1/frida-multiple-unpinning/**/
setTimeout(function() {
    Java.perform(function() {
        console.log('');
        console.log('======');
